...
public:
   ...
   REAL orient2dadapt(vector<REAL> pa, vector<REAL> pb, vector <REAL> pc, REAL detsum);
   REAL orient2d(vector<REAL> pa, vector <REAL> pb, vector <REAL> pc);
   REAL incirclefast(const REAL *pa, const REAL *pb, const REAL *pc, const REAL *pd);
   REAL incircleadapt(vector <REAL> pa, vector <REAL> pb, vector <REAL> pc, vector <REAL> pd,
                      REAL permanent);
   REAL incircle(vector<REAL> pa, vector <REAL> pb, vector< REAL> pc, vector <REAL> pd);
