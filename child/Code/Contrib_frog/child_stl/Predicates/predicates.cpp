...
REAL Predicates::orient2dadapt(vector<REAL> pa, vector <REAL> pb, vector <REAL> pc, REAL detsum) 
{ 
  SET_DOUBLE_PRECISION_MODE;
...
REAL Predicates::orient2d(vector<REAL> pa, vector <REAL> pb, vector<REAL> pc)
{ 
  SET_DOUBLE_PRECISION_MODE;
  ...
  //cout << "pa[0] = " << pa[0] << " " << "pc[0] =" << pc[0] << endl;
  //cout << "pb[1] = " << pb[1] << " " << "pc[1] =" << pc[1] << endl;
  //cout << "DETLEFT =" << detleft << endl;
  detright = (pa[1] - pc[1]) * (pb[0] - pc[0]);
  //cout << "DETRIGHT =" << detright << endl;  
...
REAL Predicates::incircleadapt(vector <REAL> pa, vector <REAL> pb, vector <REAL> pc, vector <REAL> pd,
                   REAL permanent) 
{ 
  SET_DOUBLE_PRECISION_MODE;
...
REAL Predicates::incircle(vector <REAL> pa, vector <REAL> pb, vector <REAL> pc, vector <REAL> pd)
{ 
  SET_DOUBLE_PRECISION_MODE;
