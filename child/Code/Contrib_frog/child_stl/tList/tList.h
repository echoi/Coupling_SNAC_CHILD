...
public:
  ...
  inline void insertAtBack( NodeType );  // puts copy of item at list back
...
protected:
  ...
  ListNodeType * getNewNode( NodeType  ); // makes new node
};
