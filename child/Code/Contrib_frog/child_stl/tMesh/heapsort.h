...
template<class TYPE>
void heapsort(int ,vector<TYPE>);



template<class TYPE>
void shunt(int k,int m,TYPE const& temp, vector<TYPE> array){
...
template<class TYPE>
void heapsort(int n,vector<TYPE> array){
  ...
  */
  ...
  //cout << "vector à 0 = " << array[0]->x() << endl;
  {
