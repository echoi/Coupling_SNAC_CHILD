...
*/
/***************************************************************************/
#ifndef TIPPERTRIANGULATOR_H
#define TIPPERTRIANGULATOR_H
...
#if defined(DEBUG_PRINT)
  void print(vector<point*> p) const;
#endif
  void write(std::ofstream& f,const vector <point*>& p) const;
  bool visible(vector<point*> p,int i) const;
