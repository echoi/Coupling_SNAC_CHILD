...
public:
   ...
   int ExtricateNode( tSubNode *, deque< tSubNode * > );
   ...
   int RepairMesh( deque< tSubNode *>  );
   int AddEdgeAndMakeTriangle( deque< tSubNode *> );
   int AddEdgeAndMakeTriangle( tSubNode*, tSubNode*, tSubNode* );
   int MakeTriangle( deque< tSubNode *>);
...
private:
   ...
   static int orderREdge(const tEdge *,const tEdge *);
   static int orderRTriangle( tTriangle *, tTriangle *);

protected:
   nodeList_t nodeList; // list of nodes
   edgeList_t edgeList;    // list of directed edges
   deque < tTriangle * > triList;  // list of ptrs to triangles
